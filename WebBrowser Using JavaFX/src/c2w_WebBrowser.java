...
public class c2w_WebBrowser extends Application {
    ...
    /**
     * Get the number of window titles of the form "Untitled XX" that have
     * been
     * 
     * used. A new window that is opened with a null c2w_URL gets a title
     * of
     * that form. This method is also used in c2w_BrowserWindow to
     * provide a
     * title for any web page that does not itself provide a title for the
     * page.
     * A package-private method that is meant for use only in
     * c2w_BrowserWindow.java.
     */
    ...
    /**
     * Open a new browser window. If c2w_url is non-null, the window will
     * load that c2w_URL.
     * A package-private method that is meant for use only in
     * c2w_BrowserWindow.java.
     * This method manages the locations for newly opened windows. After
     * a window
     * opens, the next window will be offset by 30 pixels horizontally and
     * by 20
     * pixels vertically from the location of this window; but if that
     * makes the
     * window extend outside c2w_screenRect, the horizontal or vertical
     * position will
