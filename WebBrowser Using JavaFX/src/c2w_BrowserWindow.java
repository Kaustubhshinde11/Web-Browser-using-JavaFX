...
/**
 * This package-private class defines one c2w_browser window for use with
...
class c2w_BrowserWindow extends Stage {
     ...
     * 
     * @param c2w_browser    the WebBrowser application that is createing
     *                       this window
     * @param c2w_initialURL if non-null, the window will attempt to load
     *                       this URL
     */
    c2w_BrowserWindow(c2w_WebBrowser c2w_browser, String c2w_initialURL) {
        c2w_owner = c2w_browser;
        /*
         * The WebView is the actual visual control in the window, showing
         * 
         * a web page.
         * 
         * The WebEngine is responsible for loading and managing the web
         * 
         * page. It is
         * 
         * the major part of the controller for the WebView. (The data
         * 
         * model for the
         * 
         * web view is a data structure that contains the web page
         * 
         * content.)
         */
        ...
        /*
         * Get a title for the window and a URL for the location label
         * 
         * from
         * 
    ...
    /**
     * Create a menu bar for the window. The only menu is a "Window"
     * menu.
...
/**
* This method is called when the user clicks the window menu, but
before the
* menu actually pops up. It removes any items beyond the four
permanent
